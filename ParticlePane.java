...
public class ParticlePane extends Pane{
	...
	private StaticsTrackPane staticsTrackPane;

	public ParticlePane() throws FileNotFoundException {
		//initial
		inputstream = new FileInputStream("space.jpg");
	...
	public ParticlePane(ArrayList<Particle> obj, StaticsTrackPane obj2) throws FileNotFoundException {
		//initial
		this.staticsTrackPane = obj2;
		inputstream = new FileInputStream("C:\\ComputerScience\\java-2020-06\\Project\\JavaFx\\src\\ParticleSimulation\\space.jpg");
		backgroundImage = new Image(inputstream);
		particle = obj;
